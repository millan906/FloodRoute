...
def build_analytical_map(
    ...
    *,
    ...
    zoom_start: int = 13,
    all_routes: object = None,
    node_info: object = None,
    demand_fraction: float | None = None,
    shelter_labels: object = None,
    osm_candidates: object = None,
    active_osm_ids: object = None,
    operating_mode: object = None,
    road_overrides: object = None,
    highlighted_override_pairs: object = None,
    shelter_types: object = None,
    fit_bounds_to_routes: bool = False,
) -> folium.Map:
